...
def parse_my_arg (args):
    ...
    parser.add_argument("directory", help="show this help message and exit" ,
                       nargs='?', default='.')                   
    ...
    parser.add_argument("-s","--sizes",help=" show sizes [default: off]" ,
                       action="store_true")
    parser.add_argument("-o","--ordered",help="order by"
                       "('name', 'n', 'modified', 'm', 'size', 's')",
                       default= 'name',
                       choices=['name','modified','size','s','m','n'],
                       nargs='?')
    parser.add_argument("-r","--recursive",
                       help="recurse into subdirectories [default: off]",
                       action = "store_true")
    parser.add_argument("-m","--modified", help=" show last modified date/time"
